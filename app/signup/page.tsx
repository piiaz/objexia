...
const InputField = ({ 
    label, type = "text", placeholder, value, onChange, onBlur, icon, error, className = "", minLength 
}: any) => {
    ...
    return (
        <div className={`space-y-1 ${className}`}>
            <div className="flex justify-between">
                ...
                {/* Optional: Show small error text top right */}
...
export default function SignupPage() {
    ...
    // Track which fields the user has visited (blurred)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Force all fields to be touched on submit to show errors if empty
    ...
    const hasError = (field: keyof typeof formData) => {
        // Job Title and Age are optional, so no error for them
            ...
            >
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                            <InputField 
                                ...
                                icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>}
                            />
                            <InputField 
                                label="Last Name" 
                                placeholder="Shukur" 
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div className="col-span-2">
                                <InputField 
                                    label="Job Title" placeholder="e.g. Product Manager" value={formData.jobTitle} onChange={(e: any) => setFormData({...formData, jobTitle: e.target.value})}
                            ...
                            <div className="col-span-1">
                                <InputField 
                                    label="Age" type="number" placeholder="25" value={formData.age} onChange={(e: any) => setFormData({...formData, age: e.target.value})}
                    ...
                    <div className="text-center text-xs text-slate-500 dark:text-slate-400 font-medium">
                        Already have an account? <Link href="/login" className="text-[#3f407e] dark:text-[#b3bbea] font-bold hover:underline ml-1">Sign in</Link>
                    </div>
                </div>
            </motion.div>
